...
# MODO BRANCO/PRETO TODAS AS TELAS

# (claro ou escuro)
try:
    theme = st.runtime.scriptrunner.script_run_ctx.get_script_run_ctx().session_state["theme"]["base"]
except Exception:
...
st.markdown(
    ...
    /* Campos e métricas */
    div[data-testid="stMarkdown"], div[data-testid="stMetricValue"], div[data-testid="stDataFrame"] {{
        color: {text_color} !important;
    }}
