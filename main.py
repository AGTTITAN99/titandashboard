...
# MODO BRANCO/PRETO ADPTATIVO 

import streamlit as st

# (escuro/claro)
theme = st.get_option("theme.base") if "theme.base" in st.runtime.scriptrunner.script_run_ctx.get_script_run_ctx().session_state else "light"

# ajusta fundo e as cores
if theme == "dark":
